...
from llm_spec.web.core.db import Base, engine
from llm_spec.web.core.error_handler import llm_spec_exception_handler
from llm_spec.web.core.exceptions import LlmSpecError
...
if __name__ == "__main__":
    uvicorn.run("llm_spec.web.main:app", host="0.0.0.0", port=8000, reload=True)
