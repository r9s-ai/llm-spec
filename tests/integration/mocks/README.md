...
pytest tests/integration/test_suite_runner.py --mock -v

# Or set environment variable
MOCK_MODE=1 pytest tests/integration/test_suite_runner.py -v

# Run specific test with mock
pytest tests/integration/test_suite_runner.py --mock -k "test_baseline" -v
```
...
Find the test case in the suite file (e.g., `suites/openai/chat_completions.json5`):
...
MOCK_RECORD=1 pytest tests/integration/test_suite_runner.py -k "test_my_feature"
```
...
```
FileNotFoundError: Mock data not found: tests/integration/mocks/openai/v1_chat_completions/test_my_test.json
```
