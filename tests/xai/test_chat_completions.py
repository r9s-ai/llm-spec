"""xAI Chat Completions API 测试"""

import pytest

from llm_spec.reporting.collector import ReportCollector
from llm_spec.validation.schemas.xai import ChatCompletionResponse
...
class TestChatCompletions:
    ...
    def setup_collector(self, xai_client):
        ...
        collector = ReportCollector(
            ...
            base_url=xai_client.get_base_url(),
        )

        # 设置为类属性，所有测试方法共享
        self.__class__.client = xai_client
