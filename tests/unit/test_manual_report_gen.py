    ...
    mock_report_data: ReportData = {
        ...
        "parameter_support_details": [
            ...
            },
            {
                ...
                "request_ok": True,
                "validation_ok": True,
                "value": "This is a very long string that should be truncated in the report to ensure it doesn't break the layout. "
                * 3,
            ...
            },
            {
                ...
                "request_ok": True,
                "validation_ok": True,
                "value": "assets/audio/hello_en.mp3",
                "test_name": "test_file_path",
            },
            {
                "parameter": "complex_object",
                "request_ok": True,
                "validation_ok": True,
                "value": {"key": "value", "nested": {"list": [1, 2, 3]}},
                "test_name": "test_complex_object",
            },
            {
                "parameter": "data_uri",
                "request_ok": True,
